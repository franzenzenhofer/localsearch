      ...
      <CardContent>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
          ...
          {isImage && (
            <>
              <Box>
                <Typography variant="caption" color="text.secondary">EXIF Data:</Typography>
                <Typography variant="body2">Available for processing</Typography>
              </Box>
              <Box>
          ...
          <Box>
            <Typography variant="caption" color="text.secondary">Indexing:</Typography>
            <Chip 
