...
test.describe('LocalSearch Application', () => {
  ...
  test('should display the main interface', async ({ page }) => {
    ...
    await expect(page.locator('p')).toContainText('Private, offline folder search');
  });
  ...
  test('should have proper accessibility', async ({ page }) => {
    ...
    await expect(page.locator('#search-input')).toHaveAttribute('placeholder', 'Search your files...');
